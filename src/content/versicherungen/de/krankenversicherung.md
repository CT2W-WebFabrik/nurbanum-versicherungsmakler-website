...
Neben der Vollversicherung gibt es die Krankenzusatzversicherung: Sie ergänzt den Schutz der GKV um Leistungen, die dort nicht oder nur eingeschränkt enthalten sind -- etwa Zahnersatz, Einzelzimmer im Krankenhaus, Heilpraktiker oder Chefarztbehandlung.
...
Bedenken Sie: Die Rückkehr in die GKV ist ab einem bestimmten Alter praktisch ausgeschlossen. Familienangehörige ohne eigenes Einkommen müssen separat versichert werden.

### Krankenzusatzversicherung

Für alle, die in der GKV bleiben möchten oder müssen, bieten Zusatzversicherungen gezielte Ergänzungen:

- **Zahnzusatzversicherung**: Der am häufigsten nachgefragte Zusatzschutz. Die GKV erstattet bei Zahnersatz nur den Festzuschuss. Eine Zahnzusatzversicherung übernimmt 70 bis 100 Prozent der Kosten für Kronen, Brücken, Implantate und Inlays.
- **Stationäre Zusatzversicherung**: Einzelzimmer, Chefarztbehandlung und freie Krankenhauswahl im stationären Bereich.
- **Ambulante Zusatzversicherung**: Heilpraktiker, Sehhilfen, erweiterte Vorsorge.
- **Auslandsreisekrankenversicherung**: Weltweiter Schutz bei Erkrankung oder Unfall im Ausland, einschließlich Rücktransport.
- **Krankentagegeld**: Schließt die Lücke zwischen Krankengeldbezug (GKV: 70 Prozent des Bruttos, maximal 90 Prozent des Nettos) und dem tatsächlichen Nettoeinkommen.

## Worauf sollten Sie achten?

- **Beitragsentwicklung in der PKV**: Die Beiträge steigen im Alter. Achten Sie auf Tarife mit nachhaltiger Kalkulation und ausreichenden Altersrückstellungen.
...
- **Optionstarif**: Für junge Angestellte, die die JAEG noch nicht erreicht haben, sichert ein Optionstarif das Recht, später ohne erneute Gesundheitsprüfung in die PKV zu wechseln.
...
- **Zahnzusatz erst bei Behandlungsbedarf abschließen**: Bereits angeratene oder begonnene Behandlungen sind nicht versichert.
- **Auslandsreisekrankenversicherung vergessen**: Die GKV-Karte hilft nur innerhalb der EU und auch dort nur eingeschränkt. Für Reisen außerhalb Europas ist eine Auslandsreisekrankenversicherung unverzichtbar.

## Wann sollten Sie zum Makler?

Die Wahl zwischen PKV und GKV sowie die Auswahl der richtigen Zusatzversicherungen gehören zu den komplexesten Entscheidungen im Versicherungsbereich. Die Folgen sind langfristig und teilweise irreversibel.
