...
- **Finanzstärke**: Der Versicherer sollte solide aufgestellt sein, damit er auch in 20 oder 30 Jahren noch Ihre Ansprüche bedienen kann.
...
Bei einem Wechsel des Versicherers gehen die gebildeten Altersrückstellungen teilweise verloren (nur der Basistarif-Anteil ist übertragbar). Prüfen Sie stattdessen zunächst einen Tarifwechsel innerhalb Ihres bestehenden Versicherers — darauf haben Sie einen gesetzlichen Anspruch.
